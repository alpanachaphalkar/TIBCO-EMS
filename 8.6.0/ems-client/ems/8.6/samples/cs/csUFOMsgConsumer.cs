 ...
 * 
 * $Id: csUFOMsgConsumer.cs 90180 2016-12-13 23:00:37Z $
 * 
 */

/// <summary>
/// This is a sample of a basic csUFOMsgConsumer.
///
...
///
/// Usage:  csUFOMsgConsumer [options]
///
///    where options are:
///
...
public class csUFOMsgConsumer : IExceptionListener
{
    ...
    public csUFOMsgConsumer(String[] args) 
    {
        ParseArgs(args);
        ...
        Console.WriteLine("\n------------------------------------------------------------------------");
        Console.WriteLine("csUFOMsgConsumer SAMPLE");
        Console.WriteLine("------------------------------------------------------------------------");
        ...
        {
            Console.Error.WriteLine("Exception in csUFOMsgConsumer: " + e.Message);
    ...
    {
        csUFOMsgConsumer generatedAux = new csUFOMsgConsumer(args);
    }
}
