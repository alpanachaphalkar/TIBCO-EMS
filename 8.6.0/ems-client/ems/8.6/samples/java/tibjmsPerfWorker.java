/* 
 * Copyright (c) 2005-2020 TIBCO Software Inc. 
 * All Rights Reserved. Confidential & Proprietary.
 * For more information, please contact:
 * TIBCO Software Inc., Palo Alto, California, USA
 * 
 * $Id: tibjmsPerfWorker.java 129199 2020-10-07 22:55:14Z $
 * 
 */

/*
 * The tibjmsPerfWorker class receives instructions from the
 * tibjmsPerfController class to invoke the performance message
 * consumer. At the end of the run the tibjmsPerfWorker class
 * sends the results back to the tibjmsPerfController class. The
 * tibjmsPerfWorker and tibjmsPerfController communicate over a
 * specified control topic. 
 *  
 * Usage:  java tibjmsPerfWorker [options]
 *
 *  where options are:
 *
 ...
 *                            the worker and controller communicate.
...
public class tibjmsPerfWorker implements MessageListener, Runnable
{
    /*
     * constants
     */
     ...
     */
    public tibjmsPerfWorker(String[] args)
    {
        parseArgs(args);
     ...
     * received from the controller program.
     * 
    ...
    private void printStartBanner()
    {
        System.err.println();
        System.err.println("------------------------------------------------------------------------");
        System.err.println("tibjmsPerfWorker program");
        System.err.println("------------------------------------------------------------------------");
     ...
     * instructions from the controller control program.
     */
    ...
    /**
     * Process instructions from controller program.
     * 
     * @param msg request message from controller program
     */
    private void processInstructions(MapMessage request) throws JMSException
    {
        ...
        // send reply to controller program
    ...
    /**
     * Process get performance request from controller program.
     * 
     * @param msg request message from controller program
     */
    ...
    {
        System.err.println();
        System.err.println("Usage: java tibjmsPerfWorker [options]");
        System.err.println();
    ...
    {
        tibjmsPerfWorker t = new tibjmsPerfWorker(args);
    }
}
