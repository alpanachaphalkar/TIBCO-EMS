/* 
 * Copyright (c) 2002-2019 TIBCO Software Inc. 
 * All Rights Reserved. Confidential & Proprietary.
 * For more information, please contact:
 * TIBCO Software Inc., Palo Alto, California, USA
 * 
 * $Id: tibjmsSSLGlobal.java 109411 2019-04-12 22:48:28Z $
 * 
 */
...
public class tibjmsSSLGlobal
{
    ...
    public tibjmsSSLGlobal(String[] args)
    {
        ...
        try
        {
            ...
            // set vendor trace. Has no effect for "j2se".
            if (ssl_debug_trace)
            ...
            // if identity is PKCS12 or JKS. 'j2se' only supports
            // PKCS12 and JKS.
    ...
    void usage()
    {
        ...
        System.err.println("");
        System.err.println(" -ssl_vendor       <name>      - SSL vendor: 'j2se' (the default)");
