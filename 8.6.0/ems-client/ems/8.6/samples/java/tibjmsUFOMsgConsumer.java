 ...
 * 
 * $Id: tibjmsUFOMsgConsumer.java 90180 2016-12-13 23:00:37Z $
 * 
 */

/*
 * This is a simple sample of a basic tibjmsUFOMsgConsumer.
 *
 ...
 *
 * Usage:  java tibjmsUFOMsgConsumer [options]
 *
 *    where options are:
 *
 *      -server     Server URL.
...
public class tibjmsUFOMsgConsumer
       implements ExceptionListener
{
    ...
    public tibjmsUFOMsgConsumer(String[] args)
    {
        parseArgs(args);
        ...
        /* print parameters */
        System.err.println("\n------------------------------------------------------------------------");
        System.err.println("tibjmsUFOMsgConsumer SAMPLE");
        System.err.println("------------------------------------------------------------------------");
    ...
    void usage()
    {
        System.err.println("\nUsage: tibjmsUFOMsgConsumer [options] [ssl options]");
        System.err.println("");
