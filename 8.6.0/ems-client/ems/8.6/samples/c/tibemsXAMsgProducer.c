 ...
 *
 * $Id: tibemsXAMsgProducer.c 108237 2019-03-18 21:34:01Z $
 *
 */
    ...
    int rc)
{
    ...
    baseUtils_print("XA ERROR: %s\n",message);
    baseUtils_print("\tRETURN VALUE: %d\n", rc);
...
int main(int argc, char** argv)
{
    ...
    /* print parameters */
    baseUtils_print("\n------------------------------------------------------------------------\n");
    baseUtils_print("tibemsXAMsgProducer SAMPLE\n");
    baseUtils_print("------------------------------------------------------------------------\n");
